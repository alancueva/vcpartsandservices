...
// --- Datos de Clientes ---
const CLIENT_LOGOS = [
  { id: 1, src: '/clientes/bd-instruments.png', alt: 'Logo BD Instruments' },
  { id: 2, src: '/clientes/ingemmet.png', alt: 'Logo INGEMMET' },
  { id: 3, src: '/clientes/petroperu.png', alt: 'Logo Petroperú' },
  { id: 4, src: '/clientes/confipetrol.png', alt: 'Logo Confipetrol' },
  { id: 5, src: '/clientes/proinman.png', alt: 'Logo PROINMAN S.A.C.' },
  { id: 6, src: '/clientes/copeinca.png', alt: 'Logo Copeinca' },
  // Para garantizar el efecto infinito, duplicamos los logos
  { id: 7, src: '/clientes/bd-instruments.png', alt: 'Logo BD Instruments' },
  { id: 8, src: '/clientes/ingemmet.png', alt: 'Logo INGEMMET' },
  { id: 9, src: '/clientes/petroperu.png', alt: 'Logo Petroperú' },
  { id: 10, src: '/clientes/confipetrol.png', alt: 'Logo Confipetrol' },
  { id: 11, src: '/clientes/proinman.png', alt: 'Logo PROINMAN S.A.C.' },
  { id: 12, src: '/clientes/copeinca.png', alt: 'Logo Copeinca' },
];
    ...
    <section className="py-16 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight sm:text-4xl mb-4">
          Algunos de <span className="text-red-600 italic font-serif">Nuestros Clientes</span>
        </h2>
