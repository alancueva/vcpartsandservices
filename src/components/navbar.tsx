...
export default function Navbar() {
  ...
  // 2. Función para manejar la entrada del ratón (onMouseEnter)    | "servicios"
  const handleMouseEnter = (dropdownName: "productos") => {
  ...
  const servicios: Servicio[] = [
    {
      nombre: "Lapeado y pulido de precisión",
      icon: Wrench,
      href: "/pages/servicios/lapeado-y-pulido-de-presicion",
    },
    {
      nombre: "Limpieza por Ultrasonido",
      icon: Beaker,
      href: "/pages/servicios/limpieza-de-ultrasonido",
    },
  ];
