        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-1 items-center md:items-center">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Especialistas en mantenimiento de equipos industriales y
              suministro de repuestos mecánicos y eléctricos.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              © {new Date().getFullYear()} VC Parts and Services. Todos los
              derechos reservados.
            </div>
            <div className="flex items-center space-x-4 text-sm text-gray-400">
              <span>Persona de contacto:</span>
              <span className="text-gray-300 font-medium">
                Ing. Jacques López Ortega
              </span>
            </div>
