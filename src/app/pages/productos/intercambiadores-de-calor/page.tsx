...
const IMAGENES = [
  { src: "/productos/PRODUCTOS-INTERCAMBIADORES1.png", alt: "imagen 1" },
  { src: "/productos/PRODUCTOS-INTERCAMBIADORES2.png", alt: "imagen 2" },
  { src: "/productos/PRODUCTOS-INTERCAMBIADORES3.png", alt: "imagen 3" },
];
...
const Description = [
  ...
  <p key="final" className="font-semibold text-gray-700">
    ¡No hay reemplazos dudosos en cuanto a la calidad!
  </p>,
];

export default function intercambiadoresCalor() {
  return (
    <div className="font-sans space-y-20">
      <DynamicImageGridSection
        title="Intercambiadores de Calor,"
        highlightedWord="Compresores y Bombas de tornillos"
